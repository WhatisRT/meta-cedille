...
charRange start amount = applyUpTo (λ x -> fromNat $ x + start) amount
...
symbols : List Char
symbols =
  applyUpTo (λ x -> fromNat $ x + 33) 15
  ++ applyUpTo (λ x -> fromNat $ x + 58) 7
  ++ applyUpTo (λ x -> fromNat $ x + 91) 6
  ++ applyUpTo (λ x -> fromNat $ x + 123) 4
